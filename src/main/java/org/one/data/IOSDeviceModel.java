...
public class IOSDeviceModel {
    ...
    private Boolean includeSafariInWebViews;
    ...
    public Boolean getIncludeSafariInWebViews() {
        return includeSafariInWebViews;
    }

    public void setIncludeSafariInWebViews(Boolean includeSafariInWebViews) {
        this.includeSafariInWebViews = includeSafariInWebViews;
    }
    ...
    public IOSDeviceModel[] getIosDeviceModels() {
        return iosDeviceModels;
    }

    public void setIosDeviceModels(IOSDeviceModel[] iosDeviceModels) {
        this.iosDeviceModels = iosDeviceModels;
    }
}
