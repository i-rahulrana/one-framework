...
public class FileManager {
    ...
    public static String loadJavascript(String path) throws IOException, java.io.IOException {
    ...
    public static File findFilePath(String fileName) {
        ...
        if (result == null) {
            String errorMessage = StringUtil.format("Failed to locate the {} file. Please ensure the file exists in the src directory or its subdirectories.", fileName);
    ...
    public static File saveImage(String subDirectory, String fileName, File imageFile) {
        ...
        } catch (IOException | java.io.IOException origException) {
            String errorMessage = StringUtil.format("Failed to save the image {} in the directory {}", fileName, destinationFile.getPath());
            throw new IOException(errorMessage, origException);
        }
    ...
    public static String winSpecialFolderConverter(String pathToProcess) {
        ...
        if (DETECTED_OS.equals("windows")) {
            ...
            String unsupportedMessage = StringUtil.format("Currently only windows operating systems are supported for special folders. Your detected operating system: {}", DETECTED_OS);
