...
class AndroidManager implements IDriverManager {
    ...
    private void setupAndroidSettings () {
        final var driver = (AndroidDriver) ParallelSession.getSession ().getDriver ();
    ...
    private void setupUiAutomatorDriver (final TargetProviders targetProviders) {
        ...
        try {
            ParallelSession.setDriver (new AndroidDriver (ParallelSession.getSession ().getServiceManager ()
